...
//   })
// }
export function getDailySalesReport(days = 7,
...
export function getTotalTransactions(transactions: Transaction[]): number {
	return transactions.length
}

export function getAverageTransactionValue(transactions: Transaction[]): number {
	const total = getTotalRevenue(transactions)
	const count = getTotalTransactions(transactions)
