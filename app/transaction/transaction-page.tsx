...
import { formatCurrency, useCartStore } from '@/lib/cart'
								...
								{cart.items.length === 0 ? (
									...
									<div className='space-y-3'>
										{cart.items.map((item) => (
											<div
												key={item.product.id}
												className='flex items-center gap-3 p-3 border rounded-lg justify-between'>
												<div className='flex gap-3'>
													<div className='size-16 bg-muted rounded-md overflow-hidden flex-shrink-0'>
														<img
